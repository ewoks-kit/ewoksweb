...
Each node has several attributes that follow the Ewokscore specification and are explained [here](https://ewokscore.readthedocs.io/en/latest/definitions.html#node-attributes). On a new node three items are being depicted:
