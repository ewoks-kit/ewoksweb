...
Each link has several attributes that follow the Ewokscore specification and are explained [here](https://ewokscore.readthedocs.io/en/latest/definitions.html#link-attributes). On a new link the following items are being depicted:
