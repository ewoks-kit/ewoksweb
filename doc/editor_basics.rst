...
EwoksWeb is web application where users can visually view/create/edit their workflows using the [Ewoks](http://nodeca.github.io/pica/demo/ "title text!") abstraction. It mainly employs a canvas where workflows with their Nodes and Links are being visualized and graphically edited.
