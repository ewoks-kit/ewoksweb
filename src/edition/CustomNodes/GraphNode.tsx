...
function GraphNode(props: NodeProps<NodeData>) {
  ...
  const [subgraphExistsOnServer, setSubgraphExistsOnServer] = useState<
    boolean | undefined
  >(true);
  ...
  return (
    <div className="node-content" style={{ borderColor: uiProps.colorBorder }}>
      ...
      >
        <SuspenseBoundary>
          <span
            style={{ ...style.displayNode, ...nodeWidth }}
            className="icons"
          >
            <NodeLabel
              label={
